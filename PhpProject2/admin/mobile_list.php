        ...
        <div class="span9">
		  ...
		  <div class="row-fluid">
			<div class="page-header">
				<h1>Mobile列表 <small>你可以新增修改刪除文章</small></h1>
			</div>
                      <a href="pc_add.php" class="btn btn-primary">新增文章</a> 
				...
				<tr class="pending-user">
					...
					<?php if(!empty($datas)):?>                          
                          ...
                          <tr>
                              ...
                              <td><?php echo $a_data['Platform']?></td>
                              <td>
                                  <a href="pc_edit.php?i=<?php echo $a_data['ID'];?>" class="btn btn-warning">編輯</a>
    		...
    		//表單送出
                $("a.pc_delect").on("click", function(){
                    ...
                    if(c)
                    {
                      $.ajax({
	            type : "POST",
	            url : "../php/del_pc.php", //因為此檔案是放在 admin 資料夾內，若要前往 php，就要回上一層 ../ 找到 php 才能進入 add_article.php
	            data : {
