            ...
            <form id="add_pc_form">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <input type="input" class="form-control" id="ios" value="<?php echo $data['Ios_path'];?>">
              </div>
                <div class="form-group">
                <label for="an">android載點</label>
                <input type="input" class="form-control" id="an" value="<?php echo $data['Android_path'];?>">
              </div>
              <div class="form-group">
    			...
    			if($("#title").val() == '' || $("#content").val() == ''){
    				...
    				$("div.loading").html('');
					  ...
					  //使用 ajax 送出 帳密給 verify_user.php
						$.ajax({
	            type : "POST",
	            url : "../php/update_mobile.php", //因為此檔案是放在 admin 資料夾內，若要前往 php，就要回上一層 ../ 找到 php 才能進入 add_article.php
	            data : {
                      id : $("#id").val(),
