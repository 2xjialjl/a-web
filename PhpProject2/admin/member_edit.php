          ...
          <div class="col-xs-12">
            <form id="add_pc_form">
              ...
              <div class="form-group">
                ...
                <input type="input" class="form-control" id="us" value="<?php echo $data['username'];?>">
              </div>
                <div class="form-group">
                <label for="ps">密碼</label>
                <input type="input" class="form-control" id="ps" value="<?php echo $data['password'];?>">
              </div>
                <div class="form-group">
                <label for="na">姓名</label>
                <input type="input" class="form-control" id="na" value="<?php echo $data['name'];?>">
              </div>
