      ...
      <div class="panel-heading">
        ...
        <div class="panel-category">
            ...
            <a href='mobile.php?i=<?php echo $row['ID'];?>'>....更多</a>
                <button type="submit" class="btn btn-skin" onclick="self.location.href='<?php echo $row['Ios_path'];?>'"><i class="fa fa-apple"></i> <span>iTunes</span></button>
                <button type="submit" class="btn btn-skin" onclick="self.location.href='<?php echo $row['Android_path'];?>'"><i class="fa fa-android"></i> Google Play</button>
      </div>
    </div>
  </div>
</div>
